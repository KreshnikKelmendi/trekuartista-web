...
const FifthPart = ({ thirdMediaItems, soundStates, toggleSound }) => {
  return (
    <div className="w-full bg-black px-3 lg:px-[50px] grid grid-cols-1 lg:grid-cols-3 gap-4 pb-12">
      {thirdMediaItems?.map((photo, index) => (
