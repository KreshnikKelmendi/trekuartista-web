...
import { FaCalendarCheck, FaFilePdf } from 'react-icons/fa';
import pdfFile from "../Assets/datajet/DataJet - Strategjia e Reklamimit.pdf"
            ...
            <div className="pt-0 lg:py-10 ">
                <div className="block space-y-8">
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">1</div>
                    ...
                    {/* Number 2 */}
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">2</div>
                        <div className='flex flex-col w-full lg:w-[100%]'>
                    ...
                    {/* Number 3 */}
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">3</div>
                        <div className='flex flex-col w-full lg:w-[100%]'>
                    ...
                    {/* Number 4 */}
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">4</div>
                        <div className='flex flex-col w-full lg:w-[100%]'>
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">5</div>
                        <div className='flex flex-col w-full lg:w-[100%]'>
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">6</div>
                        <div className='flex flex-col w-full lg:w-[100%]'>
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">7</div>
                        <div className='flex flex-col w-full lg:w-[100%]'>
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">8</div>
                        <div className='flex flex-col w-full lg:w-[100%]'>
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="w-10 h-10 rounded-full bg-gradient-to-r from-[#D2BADD] to-[#68A5FC] text-black flex items-center justify-center font-bold font-custom3 text-3xl">9</div>
                        <div className='flex flex-col w-full lg:w-[100%]'>
                    ...
                    <div className="flex flex-col w-full justify-center mx-auto lg:mx-0 items-center   p-4 rounded-lg shadow-lg hover:shadow-xl transition-transform duration-300 hover:scale-105">
                    <p className='text-white font-custom4 lg:w-1/2 underline underline-offset-4 text-center uppercase'>Attached you will find the document for Strategy of Advertising - Datajet</p>
                        <a
                            href={pdfFile}
                            target="_blank"
                            rel="noreferrer"
                            className="flex items-center w-fit mt-4 bg-gradient-to-t from-[#D2BADD] to-[#68A5FC] p-4 rounded-lg gap-3 text-black text-base font-semibold hover:text-gray-200 transition-colors duration-300 group"
                        >
                            <FaFilePdf className="text-3xl text-red-600 group-hover:rotate-[-10deg] transition-transform duration-300" />
                            <span className="group-hover:underline font-custom4">View & Analyze the Document</span>
                        </a>
                    </div>
